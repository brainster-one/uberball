...
namespace Uberball.Game.NetworkProtocol {
	...
	public class BulletSerializer : IEntitySerializer<Bullet> {
		...
		public void Deserialize(BinaryReader reader, ref Bullet entity, SerializationInfo info) {
		...
		/// <param name="entity">Entity.</param>
		/// <param name="info">Serialization info.</param>
		public void Serialize(BinaryWriter writer, Bullet entity, SerializationInfo info) {
